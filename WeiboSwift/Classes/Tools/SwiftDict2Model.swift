...
*/
@objc public protocol Dict2ModelProtocol {
    static func customClassMapping() -> [String: String]?
}

///  字典转模型控制器
public class Dict2ModelManager {
    private static let instance = Dict2ModelManager()
    /// 单例对象
    public class var sharedManager: Dict2ModelManager {
        return instance
    }
